...
public class UIBestScore : MonoBehaviour
{
    ...
    {
        bestScoreText.text = MainManager.Instance.playerName + ", can you beat the High Score " + MainManager.Instance.highScore + " made by " + MainManager.Instance.highScoreName + "?";
    }
